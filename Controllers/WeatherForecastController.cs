using AutentikaatioJaAutorisaatio.Services;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace AutentikaatioJaAutorisaatio.Controllers;
...
public class WeatherForecastController : ControllerBase
{
    ...
    [HttpGet("GetSecret")]
    public IActionResult GtSecretData()
    {
        return Ok("T‰m‰ on suojattua tietoa vain Admin-roolissa oleville.");
    }
}
